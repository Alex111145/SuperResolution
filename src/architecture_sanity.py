...
# --- MODELLO SPECIFICO PER SANITY CHECK ---
class SanityHybridModel(nn.Module):
    def __init__(self, output_size=512, smoothing='balanced', device='cpu'):
        ...
        # STAGE 1: RRDBNet (Configurazione Sanity)
        self.stage1 = RRDBNet(
        ...
        # STAGE 2: HAT (Configurazione Sanity HQ)
        if HAT_Arch:
            try:
                ...
                print("   🧠 [SANITY ARCH] HAT Inizializzato (Config: Workstation HQ).")
